...
- **`agent`** - adds 5 subagents (researcher, critic, builder, validator, web-researcher)
...
/dev --auto <task description>                    # Fully autonomous
/dev fix the login bug, auto approve               # Natural language
